...
public class MainMenu extends MouseAdapter {
	...
	public void draw(Graphics g) {
		...
		g.drawString("Play", (int) (playBtn.getX() + playBtn.getWidth() / 2 - strWidth / 2),(int)(playBtn.getY() + playBtn.getHeight() /2 + strHeight / 4 ));
		...
		g.setColor(Color.green);
		g.drawString("Quit", (int) (quitBtn.getX() + quitBtn.getWidth() / 2 - strWidth / 2),(int)(quitBtn.getY() + quitBtn.getHeight() /2 + strHeight / 4 ));
